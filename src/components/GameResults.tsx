...
export const GameResults = ({
  ...
  return (
    <Card className="bg-black/80 border-2 border-cyan-400 p-4 sm:p-8 backdrop-blur-sm shadow-[0_0_30px_rgba(0,255,255,0.2)]">
      <h2 className="text-xl sm:text-2xl font-bold text-cyan-400 mb-4 sm:mb-6 text-center font-mono">
        ⚔️ COMBAT RESULTS ⚔️
      </h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
        <div className="text-center space-y-2 sm:space-y-4">
          <h3 className="text-lg sm:text-xl font-mono text-cyan-300">
        ...
        <div className="text-center space-y-2 sm:space-y-4">
          <h3 className="text-lg sm:text-xl font-mono text-red-300">
            PROTOCOL:
          </h3>
          <div className="flex justify-center flex-wrap gap-2 sm:gap-3">
      ...
      <div className="text-center mt-4 sm:mt-8 space-y-2 sm:space-y-4">
        ...
        <Button
          ...
          className={`font-mono text-lg sm:text-xl py-3 sm:py-4 px-6 sm:px-8 border-0 cursor-pointer w-full sm:w-auto ${
